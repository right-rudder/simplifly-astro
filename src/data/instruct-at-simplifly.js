const instructAtSimplifly = {
  data: {
    ...
    pageKeywords:
      "flight training, flight training Mesa, flight training Arizona, flight school, flight school Mesa, flight school Arizona, pilot training, CFI training, certified flight instructor, pilot career, airline pilot, Mesa, AZ, Arizona",
    ...
    pageSummary: {
      title: "The SimpliFly Guarantee",
      paragraphs: [
        "If you have completed your private, instrument, commercial, and CFI training at SimpliFly, we have an exciting opportunity for you. As a testament to our confidence in your abilities, we offer a guaranteed interview for a teaching position as a CFI within our flight school.",
        "This exclusive opportunity allows you to showcase the knowledge and skills you have acquired during your training journey with us. Join our team of dedicated instructors, inspire future aviators, and make a meaningful impact in the aviation community. Take the next step in your career as a CFI with SimpliFly and let your passion for aviation soar.",
      ],
      buttons: [],
    },
      ...
      bullets: [
        {
          ...
          descriptions: ["To solo, you must be at least 16 years old."],
...
export default instructAtSimplifly;
