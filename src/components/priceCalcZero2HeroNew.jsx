        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-12 m-auto -space-y-4 items-center justify-center lg:flex md:space-y-0 xl:w-full">
            <div className="relative group w-full lg:w-1/2">
              <div
                aria-hidden="true"
                className="absolute top-0 w-full h-full rounded-2xl bg-gradient-to-br from-sky-200 to-sky-300 shadow-lg transition duration-500 transform-gpu"
              ></div>
            ...
            <div className="relative z-10 min-h-[screen-1/2] m-0 lg:-mx-4 group w-full lg:w-3/5 lg:max-w-3/5">
              <div
                aria-hidden="true"
                className="absolute top-0 w-full h-full rounded-2xl bg-gradient-to-b from-sky-200 to-sky-100 shadow-xl transition duration-500 transform-gpu"
              ></div>
            ...
            <div className="relative group w-full lg:w-1/2">
              <div
                aria-hidden="true"
                className="absolute top-0 w-full h-full rounded-2xl bg-gradient-to-l from-sky-200 to-sky-300 shadow-lg transition duration-500 transform-gpu"
              ></div>
